...
class PluginOcsinventoryngOcslink extends CommonDBTM
{
        ...
        if ($device = $dbu->getItemForItemtype($comp->fields['itemtype'])) {
            if ($device->getFromDB($comp->fields['items_id'])) {
                ...
                if ($ocsservers_id > 0) {
                    ...
                    $mode     = PluginOcsinventoryngOcsServer::getDevicesManagementMode(
                        $ocs_config,
     ...
     * @return int
     */
    public static function getOCSServerForItem(CommonDBTM $item)
    {
        global $DB;
        $dbu = new DbUtils();
        $query = "SELECT *
...
//            PluginOcsinventoryngHardware::getFields($ocsComputer, $cfg_ocs, $values);
     ...
     * @return array
     */
    public static function migrateComputerUpdates($computers_id, $computer_update)
    {
