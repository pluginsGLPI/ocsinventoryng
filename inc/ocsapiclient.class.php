...
/**
 * Class PluginOcsinventoryngOcsApiClient
 */
class PluginOcsinventoryngOcsApiClient extends PluginOcsinventoryngOcsClient {
   /**
    * @var apiClient
    */
   private $apiClient;
   ...
   /**
    * PluginOcsinventoryngOcsApiClient constructor.
    *
    * @param $id
    * @param $url
    */
...
//      Toolbox::logDebug($options);
      ...
      if (is_array($computerObjs)) {
         ...
         //         $xml = $this->callApi('get_computers_V1', new PluginOcsinventoryngOcsApiRequest($options));
   ...
   public function getDeletedComputers() {
      $deletedObjs = array();
      //$xml = $this->callApi('get_deleted_computers_V1', new PluginOcsinventoryngOcsApiRequest(array()));
...
//            }
   ...
   // $xml = $this->callApi('get_computers_V1', new PluginOcsinventoryngOcsApiRequest(array(
   // 'ENGINE' => 'FIRST',
   // 'OFFSET' => 0,
   // 'ASKING_FOR' => 'META',
   ...
   //      if ($request instanceof PluginOcsinventoryngOcsApiRequest) {
