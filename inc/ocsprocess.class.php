...
class PluginOcsinventoryngOcsProcess extends CommonDBTM
{
                    ...
                    if (isset($data)) {
                        ...
                        if ($res_id = $DB->doQuery($sql_id)) {
                            if ($DB->numrows($res_id) > 0) {
                                ...
                                //New ocsid
                                $changes[2] = $data["ID"];
                                PluginOcsinventoryngOcslink::history(
    ...
    public static function importComputer($import_params)
    {
        ...
        $ocsComputer = $ocsClient->getComputer($ocsid, [
            'DISPLAY' => [
                'CHECKSUM' => PluginOcsinventoryngOcsClient::CHECKSUM_HARDWARE | PluginOcsinventoryngOcsClient::CHECKSUM_BIOS  | PluginOcsinventoryngOcsClient::CHECKSUM_NETWORK_ADAPTERS,
        ...
        if (isset($data['entities_id']) && $data['entities_id'] >= 0) {
            ...
            if (!is_null($ocsComputer)) {
                ...
                $input        = self::getComputerInformations(
                    $computer,
                    PluginOcsinventoryngOcsServer::getConfig($plugin_ocsinventoryng_ocsservers_id),
                    $data['entities_id'],
                    $is_recursive
                );
            ...
            if (is_array($computer_ocs)
                ...
                if ($mixed_checksum) {
                    ...
                    if (isset($ocsComputer['HARDWARE'])) {
                        PluginOcsinventoryngOcsAdminInfosLink::updateAdministrativeInfoUseDate(
                            $line['computers_id'],
                            $plugin_ocsinventoryng_ocsservers_id,
                            $computer_updates,
                    ...
                    if ($updates['softwares'] && isset($ocsComputer["SOFTWARES"])) {
                        //import softwares
                        PluginOcsinventoryngSoftware::updateSoftware(
                            $cfg_ocs,
                            $line['computers_id'],
                    ...
                    if ($updates['drives'] && isset($ocsComputer["DRIVES"])) {
                        //import drives
                        PluginOcsinventoryngDisk::updateDisk(
                            $line['computers_id'],
                            $ocsComputer["DRIVES"],
                            $plugin_ocsinventoryng_ocsservers_id,
                            $updates['bitlocker'],
                    ...
                    if ($updates['virtualmachines'] && isset($ocsComputer["VIRTUALMACHINES"])) {
                        //import vm
                        PluginOcsinventoryngVirtualmachine::updateVirtualMachine(
                            $line['computers_id'],
                    ...
                    if ($updates['registry'] && isset($ocsComputer["REGISTRY"])) {
                        ...
                        PluginOcsinventoryngRegistryKey::updateRegistry(
                            $line['computers_id'],
                    ...
                    if ($updates['antivirus'] && isset($ocsComputer["SECURITYCENTER"])) {
                        ...
                        PluginOcsinventoryngAntivirus::updateAntivirus(
                            $line['computers_id'],
                    ...
                    if ($updates['winupdatestate'] && isset($ocsComputer["WINUPDATESTATE"])) {
                        ...
                        PluginOcsinventoryngWinupdate::updateWinupdatestate(
                            $line['computers_id'],
                    ...
                    if ($updates['osinstall'] && isset($ocsComputer["OSINSTALL"])) {
                        ...
                        PluginOcsinventoryngOsinstall::updateOSInstall(
                            $line['computers_id'],
                    ...
                    if ($updates['proxysetting'] && isset($ocsComputer["NAVIGATORPROXYSETTING"])) {
                        ...
                        PluginOcsinventoryngProxysetting::updateProxysetting(
                            $line['computers_id'],
                    ...
                    if ($updates['networkshare'] && isset($ocsComputer["NETWORKSHARE"])) {
                        ...
                        PluginOcsinventoryngNetworkshare::updateNetworkshare(
                            $line['computers_id'],
                    ...
                    if ($updates['runningprocess'] && isset($ocsComputer["RUNNINGPROCESS"])) {
                        ...
                        PluginOcsinventoryngRunningprocess::updateRunningprocess(
                            $line['computers_id'],
                    ...
                    if ($updates['service'] && isset($ocsComputer["SERVICE"])) {
                        ...
                        PluginOcsinventoryngService::updateService(
                            $line['computers_id'],
                            $ocsComputer["SERVICE"],
                            $cfg_ocs,
                            1
                    ...
                    if ($updates['winuser'] && isset($ocsComputer["WINUSERS"])) {
                        ...
                        PluginOcsinventoryngWinuser::updateWinuser(
                            $line['computers_id'],
                    ...
                    if ($updates['teamviewer'] && isset($ocsComputer["TEAMVIEWER"])) {
                        ...
                        PluginOcsinventoryngTeamviewer::updateTeamviewer(
                            $line['computers_id'],
                    ...
                    if ($updates['customapp'] && isset($ocsComputer["CUSTOMAPP"])) {
                        //import teamviewer entries
                        PluginOcsinventoryngCustomapp::updateCustomapp(
                            $line['computers_id'],
