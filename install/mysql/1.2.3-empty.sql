...
CREATE TABLE `glpi_plugin_ocsinventoryng_ocsservers` (
  ...
  `import_device_motherboard` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `dohistory` tinyint(1) NOT NULL DEFAULT '0',
  `history_hardware` tinyint(1) NOT NULL DEFAULT '0',
  `history_bios` tinyint(1) NOT NULL DEFAULT '0',
  `history_drives` tinyint(1) NOT NULL DEFAULT '0',
  `history_network` tinyint(1) NOT NULL DEFAULT '0',
  `history_devices` tinyint(1) NOT NULL DEFAULT '0',
  `history_monitor` tinyint(1) NOT NULL DEFAULT '0',
  `history_printer` tinyint(1) NOT NULL DEFAULT '0',
  `history_peripheral` tinyint(1) NOT NULL DEFAULT '0',
  `history_sofware` tinyint(1) NOT NULL DEFAULT '0',
  `history_vm` tinyint(1) NOT NULL DEFAULT '0',
  `history_admininfos` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
