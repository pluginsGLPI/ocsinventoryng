 ...
 * Class Osinstall
 */
class Osinstall extends \CommonDBTM
{
     ...
     * @param $force
     */
    public static function updateOSInstall($computers_id, $ocsComputer, $cfg_ocs, $force)
    {
    ...
    {
        return "glpi_plugin_ocsinventoryng_osinstalls";
    }
     ...
     *
     */
    public static function resetOSInstall($glpi_computers_id, $uninstall_history)
    {
    ...
    public static function showForItem_OperatingSystem($params)
    {
        ...
        if ($item->getField('itemtype') == 'Computer'
          && $computer->getFromDB($item->getField('items_id'))) {
            $plugin_ocsinventoryng_ocsservers_id = Ocslink::getOCSServerForItem($computer);
            ...
            if ($plugin_ocsinventoryng_ocsservers_id > 0
             && OcsServer::serverIsActive($plugin_ocsinventoryng_ocsservers_id)) {
                ...
                Ocslink::showLockIcon($items_id, $data);
                ...
                if (//               ($item->getType() == 'Item_OperatingSystem')
                    ...
                    if ($result = $DB->request([
                        ...
                        'WHERE' => ['computers_id' => $computer->getID()],
