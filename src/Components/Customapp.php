 ...
 * Class Customapp
 */
class Customapp extends CommonDBTM
{
    ...
    {
        return "glpi_plugin_ocsinventoryng_customapps";
    }
     ...
     *
     * @param             $comp                  CommonGLPI object
     * @param bool|string $withtemplate boolean  Template or basic item (default '')
     *
     * @return bool
*/
    // TODO
    public static function showForComputer($comp, $withtemplate = '')
    {
        global $DB;
