...
class Officepack
{
     ...
     */
    public static function updateOfficePack(
        $computers_id,
        $softwares_id,
        $softwares_name,
        $softwareversions_id,
     ...
     */
    public static function resetOfficePack($glpi_computers_id, $uninstall_plugins_history)
    {
        global $DB;
        ...
        if ($DB->numrows($result) > 0) {
            ...
            $item_softwarelicenses = new Item_SoftwareLicense();
            $item_softwarelicenses->deleteByCriteria(
                ['items_id' => $glpi_computers_id,
                    'itemtype' => 'Computer'],
                0,
                $uninstall_plugins_history
            );
        }
    }
}
