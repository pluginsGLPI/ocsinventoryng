 ...
 * Class Proxysetting
 */
class Proxysetting extends \CommonDBTM
{
     ...
     * @param $force
     */
    public static function updateProxysetting($computers_id, $ocsComputer, $cfg_ocs, $force)
    {
    ...
    {
        return "glpi_plugin_ocsinventoryng_proxysettings";
    }
    /**
     ...
     *
     */
    public static function resetProxysetting($glpi_computers_id, $uninstall_history)
    {
