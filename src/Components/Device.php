...
class Device
{
     ...
     */
    public static function updateDevices($devicetype, $ocsComputer, $params)
    {
        ...
        switch ($devicetype) {
            case "Item_DeviceFirmware":
                ...
                $bios["manufacturers_id"]        = Dropdown::importExternal(
                    'Manufacturer',
                ...
                $bios["devicefirmwaremodels_id"] = Dropdown::importExternal(
                    'DeviceFirmwareModel',
                    OcsProcess::encodeOcsDataInUtf8(
                        $ocs_db_utf8,
                        $ocsComputer["SMODEL"]
                ...
                $bios["devicefirmwaretypes_id"]  = Dropdown::importExternal(
                    'DeviceFirmwareType',
                    OcsProcess::encodeOcsDataInUtf8(
                        $ocs_db_utf8,
                        $ocsComputer["TYPE"]
                ...
                foreach ($ocsComputer as $line2) {
                    if (isset($line2["CAPACITY"])
                     ...
                     && $line2["CAPACITY"] > 0) {
                        ...
                        $ram["devicememorytypes_id"] = Dropdown::importExternal(
                            'DeviceMemoryType',
                            $line2["TYPE"]
                        );
            ...
            case "Item_DevicePci":
                ...
                if (isset($ocsComputer['SLOTS'])) {
                    ...
                    foreach ($ocsComputer['SLOTS'] as $line2) {
                        if ($line2['NAME']) {
                            if (!$ocs_db_utf8 && !!mb_check_encoding($line2["NAME"], "UTF-8")) {
            ...
            case "Item_DeviceProcessor":
                ...
                foreach ($ocsComputer as $line2) {
                    ...
                    $processor["manufacturers_id"]  = Dropdown::importExternal(
                        'Manufacturer',
                        OcsProcess::encodeOcsDataInUtf8($ocs_db_utf8, $line2["MANUFACTURER"])
                    );
            ...
            case "Item_DeviceMotherboard":
                ...
                if (OcsProcess::encodeOcsDataInUtf8($ocs_db_utf8, $ocsComputer["MMANUFACTURER"]) != null) {
                    $mb["manufacturers_id"] = Dropdown::importExternal(
                        'Manufacturer',
                        OcsProcess::encodeOcsDataInUtf8($ocs_db_utf8, $ocsComputer["MMANUFACTURER"])
                    );
                }
            ...
            case "Item_DeviceControl":
                ...
                foreach ($ocsComputer as $line2) {
                    if ($line2['NAME']) {
                        ...
                        $ctrl["manufacturers_id"] = Dropdown::importExternal(
                            'Manufacturer',
                            OcsProcess::encodeOcsDataInUtf8(
                                $ocs_db_utf8,
                                $line2["MANUFACTURER"]
     ...
     * @return void .
     */
    public static function resetDevices($glpi_computers_id, $itemtype, $history)
    {
