...
class RegistryKey extends \CommonDBTM
{
    ...
    {
        return "glpi_plugin_ocsinventoryng_registrykeys";
    }
     ...
     * @param $force
     */
    public static function updateRegistry($computers_id, $ocsComputer, $cfg_ocs, $force)
    {
     ...
     *
     * */
    public static function resetRegistry($glpi_computers_id, $uninstall_history)
    {
     ...
     * @return bool
     */
    public static function showForComputer($ID)
    {
        global $DB;
        ...
        if ($result = $DB->doQuery($query)) {
            if ($DB->numrows($result) != 0) {
                ...
                echo "<tr><th colspan='4'>" . sprintf(
                    _n(
                        '%d registry key found',
