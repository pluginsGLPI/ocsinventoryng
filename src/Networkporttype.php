...
class NetworkPortType extends CommonDropdown
{
        ...
        if (isset($this->input['transform_unknown_ports_that_match']) &&
          $this->input['transform_unknown_ports_that_match']) {
            ...
            $criteria = [
                ...
                'WHERE' => [
                    'TYPE' => $this->fields['OCS_TYPE'],
                ],
            ];
            if ($this->fields['OCS_TYPEMIB'] != '*') {
                $criteria['WHERE'] = $criteria['WHERE'] + ['TYPEMIB' => $this->fields['OCS_TYPEMIB']];
            }
     ...
     * @return string
     */
    public static function getLinkToCreateFromTypeAndTypeMIB(array $fields = [])
    {
     ...
     * @return bool|true
     */
    public function getFromTypeAndTypeMIB(array $fields = [])
    {
