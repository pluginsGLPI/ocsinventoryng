 ...
 * Class OcsAlert
 */
class OcsAlert extends CommonDBTM
{
     ...
     * @return string
     */
    public static function queryNew($delay_ocs, $config, $entity)
    {
...
//        $query .= " ORDER BY `glpi_plugin_ocsinventoryng_ocslinks`.`last_ocs_update` DESC";
    ...
    public static function displayBody($data)
    {
        ...
        $body .= "<td>" . Dropdown::getDropdownName(
            ...
            $item_operatingsystems->getField("operatingsystems_id")
        ) . "</td>";
     ...
     * @return int
     */
    public static function cronSynchroAlert($task = null)
    {
        global $DB, $CFG_GLPI;
            ...
            foreach ($DB->request([
                ...
                foreach ($DB->request($query_ocs) as $data) {
                    ...
                    if (!isset($ocs_messages[$type][$entity])) {
                        $ocs_messages[$type][$entity] = OcsAlert::getTypeName(2) . "<br />";
                    }
     ...
     * @return int
     */
    public static function cronAlertNewComputers($task = null)
    {
        global $DB, $CFG_GLPI;
     ...
     * @param $ID
     */
    public static function configCron()
    {
    ...
    public static function showNotificationOptions(Entity $entity)
    {
        ...
        Alert::dropdownIntegerNever(
            'use_newocs_alert',
            $entitynotification->fields["use_newocs_alert"],
            ['max'            => 99,
                'inherit_global' => 1]
        );
        ...
        Alert::dropdownIntegerNever(
            'delay_ocs',
            $entitynotification->fields["delay_ocs"],
            ['max'            => 99,
                'inherit_global' => 1]
        );
        echo "&nbsp;" . _n('Day', 'Days', 2) . "</td>";
