 ...
 * Class OcsSoapClient
 */
class OcsSoapClient extends OcsClient {
   /**
    * @var SoapClient
    */
   private $soapClient;
   ...
   public function getComputers($options, $id = 0) {
      ...
      do {
         ...
         $xml = $this->callSoap('get_computers_V1', new OcsSoapRequest($options));
   ...
   public function getDeletedComputers() {
      $deletedObjs = [];
      //$xml = $this->callSoap('get_deleted_computers_V1', new OcsSoapRequest(array()));
   ...
   public function getAccountInfoColumns($table) {
      $xml = $this->callSoap('_get_account_fields_V1', new OcsSoapRequest());
      $res = [
   ...
   // $xml = $this->callSoap('get_computers_V1', new OcsSoapRequest(array(
   // 'ENGINE' => 'FIRST',
   // 'OFFSET' => 0,
   // 'ASKING_FOR' => 'META',
   ...
   private function callSoap($method, $request) {
      if ($request instanceof OcsSoapRequest) {
