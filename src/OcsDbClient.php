...
class OcsDbClient extends OcsClient
{
  ...
  //             $where_before .= "'" .$before. "'";
        ...
        if ($count_query) {
            $count_request        = $this->db->doQuery($count_query);
    ...
    *
    * @return array
    * @see OcsClient::getComputersToUpdate()
    *
    */
   ...
   /**
    * @see OcsClient::getDeletedComputers()
    */
