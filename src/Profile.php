...
class Profile extends \Profile
{
    ...
    public function getTabNameForItem(CommonGLPI $item, $withtemplate = 0)
    {
        if ($item->getType() == 'Profile'
            ...
            return self::createTabEntry(Menu::getTypeName(2));
        }
        return '';
    }
    ...
    public function showForm($profiles_id = 0, $openform = true, $closeform = true)
    {
        ...
        echo "<tr><th colspan='4' class='center b'>" . sprintf(
            __('%1$s - %2$s'),
            'OcsinventoryNG',
            $profile->fields["name"]
        ) . "</th>";
        ...
        if (Session::haveRight("profile", UPDATE)) {
            Dropdown::show(OcsServer::class, ['width'     => '50%',
                'used'      => $used,
                'value'     => '',
        ...
        $dbu = new DbUtils();
        $nbservers = $dbu->countElementsInTable(
     ...
     * @param $profile
     */
    public static function addAllServers($profile)
    {
        global $DB;
