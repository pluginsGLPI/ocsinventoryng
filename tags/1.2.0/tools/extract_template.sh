...
xgettext *.php */*.php --copyright-holder='Ocsinventoryng Development Team' --package-name='GLPI - Ocsinventoryng plugin' --package-version='1.1.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
